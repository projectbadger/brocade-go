...
- [type BrocadeFRU](#type-brocadefru)
- [type Fan](#type-fan)
- [type PowerSupply](#type-powersupply)
- [type RESTFRU](#type-restfru)
  - [NewRESTFRU() RESTFRU](#func-newrestfru-restfru)


## type [Blade](<brocadeFRU.go#L19>)
```go
type Blade struct {
...
## type [BrocadeFRU](<brocadeFRU.go#L9>)
...
## type [PowerSupply](<brocadeFRU.go#L154>)
